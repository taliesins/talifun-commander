...
namespace Talifun.Commander.Configuration
{
    ...
    [InheritedExport]
    public abstract class CurrentConfigurationElementCollection<T> : ConfigurationElementCollection where T : ConfigurationElement, new()
    {
        /// <summary>
        ...
        public static string CollectionSettingName { get; protected set; }
        public static string ElementSettingName { get; protected set; }
