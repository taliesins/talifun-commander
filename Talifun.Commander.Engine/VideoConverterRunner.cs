using System;
using System.IO;
using Talifun.Commander.Command.Video;
using Talifun.Commander.Configuration;

namespace Talifun.Commander.MediaConversion
{
    public class VideoConverterRunner : ICommandRunner<VideoConversionSettingElement>
    {
        ...
        public void Run(ICommanderManager commanderManager, FileInfo inputFilePath, VideoConversionSettingElement videoConversionSetting)
        {
