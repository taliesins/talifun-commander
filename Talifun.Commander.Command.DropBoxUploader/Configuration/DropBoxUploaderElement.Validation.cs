...
{
	public partial class DropBoxUploaderElement : IDataErrorInfo
	{
		public bool IsValid
		{
		...
		{
			return ValidationHelper.Validate<DropBoxUploaderElementValidator, DropBoxUploaderElement>(this);
		}
