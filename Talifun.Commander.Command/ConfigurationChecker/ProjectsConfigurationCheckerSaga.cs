...
{
	[Serializable]
	public class ProjectsConfigurationCheckerSaga : SagaStateMachine<ProjectsConfigurationCheckerSaga>, ISaga
	{
		static ProjectsConfigurationCheckerSaga()
		{
			Define(() =>
			{
				Initially(
		...
		public ProjectsConfigurationCheckerSaga(Guid correlationId)
		{
		...
		{
            ProjectConfigurationsToTest = CommanderSettings.Projects
		    ...
		    var appSettings = AppSettings.Settings.ToDictionary();
