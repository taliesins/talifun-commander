...
{
	public partial class AudioConversionElement : IDataErrorInfo
	{
		public bool IsValid
		{
		...
		{
			return ValidationHelper.Validate<AudioConversionElementValidator, AudioConversionElement>(this);
		}
