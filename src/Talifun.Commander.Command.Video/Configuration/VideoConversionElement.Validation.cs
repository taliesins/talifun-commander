...
{
	public partial class VideoConversionElement : IDataErrorInfo
	{
		public bool IsValid
		{
		...
		{
			return ValidationHelper.Validate<VideoConversionElementValidator, VideoConversionElement>(this);
		}
