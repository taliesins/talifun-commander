...
namespace Talifun.Commander.Command.Configuration
{
    ...
    public class ProjectElementCollection : CurrentConfigurationElementCollection<ProjectElement>
    {
        ...
        {
            return new ConfigurationProperty(Setting.ElementCollectionSettingName, typeof(ProjectElementCollection), new ProjectElementCollection(), ConfigurationPropertyOptions.None);
        }
    }
}
