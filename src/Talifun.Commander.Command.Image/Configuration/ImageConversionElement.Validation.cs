...
{
	public partial class ImageConversionElement : IDataErrorInfo
	{
		public bool IsValid
		{
		...
		{
			return ValidationHelper.Validate<ImageConversionElementValidator, ImageConversionElement>(this);
		}
